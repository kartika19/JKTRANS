    ...
    <h1>TAMBAH DATA REKAPAN</h1>
     ...
     <form method="POST" action="">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="number" class="form-control" placeholder="Kode"  name="kode_rekap" value='<?php echo $data['kode_rekap'];?>' required>
        </div>
      </div>
      <div class="form-group row">
        <label for="nama" class="col-sm-2 col-form-label">Colli</label>
        <div class="col-sm-10">
          <input type="number" class="form-control" placeholder="Colli" name="colli" value='<?php echo $data['colli'];?>' required>
        </div>
      </div>
      <div class="form-group row">
        <label for="nama" class="col-sm-2 col-form-label">Berat</label>
        <div class="col-sm-10">
          <input type="number" class="form-control" placeholder="Berat" name="berat" value='<?php echo $data['berat'];?>' required>
        </div>
      </div>
      <div class="form-group row">
        <label for="kode" class="col-sm-2 col-form-label">Confrankert</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" placeholder="Confrankert"  name="confrankert" value='<?php echo $data['confrankert'];?>' required>
        </div>
      </div>
      <div class="form-group row">
        <label for="nama" class="col-sm-2 col-form-label">Penerima Barang</label>
        <div class="col-sm-10">
          <input type="text" class="form-control"  placeholder="Penerima Barang" name="nama_penerima" value='<?php echo $data['penerima'];?>' required>
        </div>
      </div>
      <div class="form-group row">
        <label for="nama" class="col-sm-2 col-form-label">Keterangan</label>
        <div class="col-sm-10">
          <input type="text" class="form-control"  placeholder="Keterangan" name="keterangan" value='<?php echo $data['keterangan'];?>' required>
        </div>
      </div>
  <?php }?>
      <center>
