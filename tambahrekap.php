    ...
    <h1>TAMBAH DATA REKAPAN</h1>
     ...
     <form method="POST" action="">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="number" class="form-control" placeholder="Kode"  name="kode_rekap">
        </div>
      </div>
      <div class="form-group row">
        <label for="nama" class="col-sm-2 col-form-label">Colli</label>
        <div class="col-sm-10">
          <input type="number" class="form-control" placeholder="Colli" name="colli">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" placeholder="Confrankert"  name="confrankert">
        </div>
      </div>
      <div class="form-group row">
        <label for="nama" class="col-sm-2 col-form-label">Penerima Barang</label>
        <div class="col-sm-10">
          <input type="text" class="form-control"  placeholder="Penerima Barang" name="nama_penerima">
        </div>
      </div>
      <div class="form-group row">
